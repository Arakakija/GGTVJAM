...
namespace Saving
{
    ...
    {
        [ExecuteAlways] [SerializeField] private string uniqueIdentifier = "";

        private static Dictionary<string, SavingEntity> globalLookup = new Dictionary<string, SavingEntity>();
